    ...
    <header className="bg-card border-b border-border px-4 lg:px-6 py-2 sticky top-0 z-10">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          {/* Avatar */}
          <div className="w-9 h-9 rounded-full bg-primary flex items-center justify-center text-primary-foreground text-sm font-bold cursor-pointer">
            A
          </div>
