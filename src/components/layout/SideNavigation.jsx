  ...
  return (
    <div className="fixed left-0 top-0 h-full w-56 bg-card border-r border-border z-10 flex flex-col py-6">
      ...
      <div className="px-4 mb-8 flex items-center gap-3">
        ...
        <span className="text-lg font-bold text-foreground">VConnect</span>
      </div>

      {/* Navigation Icons */}
      <nav className="flex flex-col gap-2 flex-1 px-2">
        <Link to="/" className="h-11 flex items-center gap-3 rounded-xl bg-primary/10 text-primary transition-all px-3" title="Home">
        ...
        <Link to="/dm" className="h-11 flex items-center gap-3 rounded-xl bg-primary/10 text-primary transition-all px-3" title="Messages">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <Link to="/discover" className="h-11 flex items-center gap-3 rounded-xl bg-primary/10 text-primary transition-all px-3" title="Discover">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <Link to="/profile" className="h-11 flex items-center gap-3 rounded-xl bg-primary/10 text-primary transition-all px-3" title="Profile">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
