...
function SideNavigation() {
  ...
  return (
    <div className="group fixed left-0 top-0 h-full w-20 hover:w-56 overflow-hidden bg-card border-r border-border z-10 flex flex-col py-6 transition-all duration-300">
